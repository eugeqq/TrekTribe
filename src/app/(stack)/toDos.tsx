          ...
          {selected && (
            <View style={{ gap: 14, paddingBottom: 10 }}>
              ...
              <LabeledInput
                ...
                onChangeText={(t) =>
                  setSelected({ ...selected, descripcion: t })
                }
                multiline
              />
                ...
                <View style={{ flexDirection: "row", gap: 10 }}>
                  {["pendiente", "completada"].map((st) => (
                    <Pressable
                      key={st}
                      onPress={() =>
                        setSelected({ ...selected, estado: st as any })
                      }
                      style={[
                        styles.stateBtn,
              ...
              <View>
                ...
                <View style={styles.dropdown}>
                  <Pressable
                    onPress={() =>
                      setSelected({ ...selected, responsableId: null })
                    }
                    style={[
                      styles.option,
                  ...
                  {participantes.map((p) => (
                    <Pressable
                      ...
                      onPress={() =>
                        setSelected({
                          ...selected,
                          responsableId: Number(p.id),
                        })
                      }
                      style={[
                        styles.option,
                        selected.responsableId === Number(p.id) &&
                          styles.optionActive,
                      ]}
                    >
                      <Text
